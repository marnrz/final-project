            ...
            <div className="error">
                <div className="error-page-content flex justify-center align-item column z-2 relative">
                    <div className="col-8 center">
                        ...
                        <p className="mb-7">Sorry, we can't find that page. You'll find lots to explore on the home page. </p>
                        <Link to="/"><Button size= "large"> <strong>Go Home </strong></Button></Link>
